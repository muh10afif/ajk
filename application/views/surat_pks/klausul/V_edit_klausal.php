    ...
    <div class="col-md-9">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Edit Klausul Asuransi</li>
            </ol>
        </nav>
    </div>
    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-header p-3">
                <h4 id="judul" class="font-weight-bold">Edit Klausal Asuransi</h4>
            </div>

            <form action="simpan_edit_klausul_data" method="post" autocomplete="off" enctype="multipart/form-data">
                    ...
                    <div class="col-md-10">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9 nm_jenis_produk">
                                <select name="jenis_produk" id="jenis_produk" placeholder="Pilih Jenis Produk">
                                    <option value=""></option>
                                    <?php foreach ($jenis_produk as $p): ?>
                                        <option value="<?= $p['id_jenis_produk'] ?>" <?= ($p['id_jenis_produk'] == $id_jenis_produk) ? 'selected' : '' ?>><?= $p['jenis_produk'] ?></option>
                                    <?php endforeach;?>
                                </select>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9 mt-2 c_jenis_ptg2" <?= ($id_jenis_produk == 3) ? 'hidden' : '' ?>>
                                <span>: UT</span>
                            </div>
                        </div>
                        <div class="form-group row">
                                            ...
                                            <div class="tab-pane fade resiko_tab <?= $tjenis1 ?>_resiko_tab <?= $tjenis1 ?>_resiko_tab<?= $id_jj ?>  p-3" id="rsk_<?= $tjenis1 ?>_resiko<?= $id_jj ?>" role="tabpanel" aria-labelledby="<?= $tjenis1 ?>_resiko<?= $id_jj ?>_tab">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <input type="text" style="font-size: 14px;" name="nama_pks_<?= $id_tjenis1.$id_jj ?>" id="nama_pks_<?= $id_tjenis1.$id_jj ?>" class="form-control" placeholder="Masukkan Nomor PKS" value="<?= $cr4['pks'] ?>">
                                                            </div>
                                                            <div class="col-md-6">
                                                                <input type="file" style="font-size: 14px;" name="pks_file_<?= $id_tjenis1.$id_jj ?>" id="pks_file_<?= $id_tjenis1.$id_jj ?>" class="form-control">
                                                                <small><mark>Upload file bila ingin mengubah!</mark></small>
                                                                <input type="hidden" name="pks_file_old_<?= $id_tjenis1.$id_jj ?>" value="<?= $cr51['nama_dokumen'] ?>">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    <label for="isi_pks_<?= $id_tjenis1.$id_jj ?>" class="col-sm-3 col-form-label">File PKS Sebelumnya</label>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <input type="text" style="font-size: 14px;" name="no_polis_<?= $id_tjenis1.$id_jj ?>" id="no_polis_<?= $id_tjenis1.$id_jj ?>" class="form-control" placeholder="Masukkan Nomor Polis Induk" value="<?= $cr4['polis_induk'] ?>">
                                                            </div>
                                                            <div class="col-md-6">
                                                                ...
                                                                <small><mark>Upload file bila ingin mengubah!</mark></small>
                                                                <input type="hidden" name="no_polis_file_old_<?= $id_tjenis1.$id_jj ?>" value="<?= $cr52['nama_dokumen'] ?>">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    <label for="isi_pks_<?= $id_tjenis1.$id_jj ?>" class="col-sm-3 col-form-label">File Polis Induk Sebelumnya</label>
                                                    <div class="col-sm-9 mt-2">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" style="font-size: 14px;" id="maksimal_plafond_<?= $id_tjenis1.$id_jj ?>" name="maksimal_plafond_<?= $id_tjenis1.$id_jj ?>" class="form-control numeric separator" placeholder="Masukkan Maksimal Plafond" value="<?= $cr4['maksimal_plafond'] ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <div class="input-group mb-3">
                                                            <input type="text" style="font-size: 14px;" id="x_plus_n_<?= $id_tjenis1.$id_jj ?>" name="x_plus_n_<?= $id_tjenis1.$id_jj ?>" class="form-control numeric" placeholder="Masukkan Batas Usia" value="<?= $cr4['x_n'] ?>">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" style="font-size: 14px;" id="free_cover_<?= $id_tjenis1.$id_jj ?>" name="free_cover_<?= $id_tjenis1.$id_jj ?>" class="form-control numeric separator" placeholder="Masukkan Free Cover" value="<?= $cr4['free_cover'] ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <div class="input-group mb-3">
                                                            <input type="text" style="font-size: 14px;" id="tenor_maksimal_<?= $id_tjenis1.$id_jj ?>" name="tenor_maksimal_<?= $id_tjenis1.$id_jj ?>" class="form-control numeric" placeholder="Masukkan Tenor Maksimal" value="<?= $cr4['tenor_maksimal'] ?>">
                                                            <div class="input-group-append">
                                                                <span class="input-group-text" id="basic-addon2">Tahun</span>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" style="font-size: 14px;" id="brokerage_<?= $id_tjenis1.$id_jj ?>" name="brokerage_<?= $id_tjenis1.$id_jj ?>" class="form-control numeric separator" placeholder="Masukkan Brokerage" value="<?= $cr4['brokerage'] ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        ...
                                                        <small><mark>Upload file bila ingin mengubah!</mark></small>
                                                        <input type="hidden" name="legalitas_old_<?= $id_tjenis1.$id_jj ?>" value="<?= $cr53['nama_dokumen'] ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label for="isi_pks_<?= $id_tjenis1.$id_jj ?>" class="col-sm-3 col-form-label">File Legalitas Sebelumnya</label>
                                                    <div class="col-sm-9 mt-2">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        ...
                                                        <small><mark>Upload file bila ingin mengubah!</mark></small>
                                                        <input type="hidden" name="compro_file_old_<?= $id_tjenis1.$id_jj ?>" value="<?= $cr54['nama_dokumen'] ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label for="isi_pks_<?= $id_tjenis1.$id_jj ?>" class="col-sm-3 col-form-label">File Legalitas Sebelumnya</label>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <select name="sel_status_1_<?= $id_tjenis1.$id_jj ?>[]" class="sel_isi_udw" plafond="<?= $i ?>" usia_masuk="1" idd="<?= $id_tjenis1.$id_jj ?>" data-allow-clear="true" placeholder="Pilih Status">
                                                                    <?php foreach ($status_dok as $s1): ?>
                                                                        <option value="<?= $s1['id_status_underwriting'] ?>" <?= ($s1['id_status_underwriting'] == $cr61['id_status_underwriting']) ? 'selected' : '' ?>><?= $s1['status_underwriting'] ?></option>
                                                                    <?php endforeach; ?>
                                                                </select>
                                                            ...
                                                            <td>
                                                                <select name="sel_status_2_<?= $id_tjenis1.$id_jj ?>[]" class="sel_isi_udw" plafond="<?= $i ?>" usia_masuk="2" idd="<?= $id_tjenis1.$id_jj ?>" data-allow-clear="true" placeholder="Pilih Status">
                                                                    <?php foreach ($status_dok as $s2): ?>
                                                                        <option value="<?= $s2['id_status_underwriting'] ?>" <?= ($s2['id_status_underwriting'] == $cr62['id_status_underwriting']) ? 'selected' : '' ?>><?= $s2['status_underwriting'] ?></option>
                                                                    <?php endforeach; ?>
                                                                </select>
                                                            ...
                                                            <td>
                                                                <select name="sel_status_3_<?= $id_tjenis1.$id_jj ?>[]" class="sel_isi_udw" plafond="<?= $i ?>" usia_masuk="3" idd="<?= $id_tjenis1.$id_jj ?>" data-allow-clear="true" placeholder="Pilih Status">
                                                                    <?php foreach ($status_dok as $s3): ?>
                                                                        <option value="<?= $s3['id_status_underwriting'] ?>" <?= ($s3['id_status_underwriting'] == $cr63['id_status_underwriting']) ? 'selected' : '' ?>><?= $s3['status_underwriting'] ?></option>
                                                                    <?php endforeach; ?>
                                                                </select>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-6 ">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-6">
                                                                <input type="text" style="font-size: 14px;" id="namefile_<?= $id_tjenis1.$id_jj ?>" name="namefile_<?= $id_tjenis1.$id_jj ?>" value="<?= $cr55['nama_dokumen'] ?>" class="form-control">
                                                            </div>
                                                        </div>
                                                    </div>
