...
<div class="row f_tiga">
    ...
    <div class="col-md-12 mt-3">
        <form id="form_tertanggung" action="<?= base_url('C_pertanggungan/tampilan_hasil_akhir') ?>" method="POST" enctype="multipart/form-data" autocomplete="off">
                ...
                <div class="card-body table-responsive ">
                        ...
                        <div class="col-sm-7">
                            <select name="id_debitur" id="id_debitur" class="id_deb_pilih" data-allow-clear="1" placeholder="Pilih Debitur">
                                ...
                                <?php foreach ($debitur as $d): ?>
                                    <option value="<?= $d['id_debitur'] ?>"><?= $d['nama_lengkap'] ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                        <div class="col-sm-2">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <select name="id_jenis_produk" id="jenis_produk" data-allow-clear="true" placeholder="Pilih Jenis Produk">
                                    <option value=""></option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9 mt-2 c_jenis_ptg2" hidden>
                                <span class="t_jenis_ptg2">: <?= ($jml_jenis_jt == 1) ? $jenis_tanggung['jenis_tanggung'] : '' ?></span>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <div class="input-group">
                                                                    <input type="text" style="font-size: 14px" name="tgl_akad_<?= $id_tjenis1.$id_jj ?>" id="tgl_akad_<?= $id_tjenis1.$id_jj ?>" id_jr = "<?= $id_tjenis1.$id_jj ?>" class="form-control datepicker2 tgl_akad" placeholder="Masukkan Tanggal Akad" aria-describedby="basic-addon2" readonly>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <div class="input-group">
                                                                    ...
                                                                    <input type="text" class="form-control datepicker2 text-center periode_asuransi_akhir" name="periode_asuransi_akhir_<?= $id_tjenis1.$id_jj ?>" id="periode_asuransi_akhir_<?= $id_tjenis1.$id_jj ?>" id_jr="<?= $id_tjenis1.$id_jj ?>" placeholder="Akhir Periode" style="font-size: 14px;" readonly required>
                                                                </div>
                                                            </div>
                                                        </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#jenis_produk').on('change', function () {
            ...
            $.ajax({
                url     : "<?= base_url('C_pertanggungan/ambil_jenis_ptg') ?>",
                method  : "POST",
                data    : {id_asuransi:id_asuransi, id_jenis_produk:isi},
                dataType: "JSON",
                success : function (data) {
                    $('.t_jenis_ptg2').text(": "+data.jenis_ptg);
                }
            })
